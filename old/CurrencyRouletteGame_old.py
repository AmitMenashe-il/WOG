...
class CurrencyRouletteGame:
    ...
    def get_money_interval(self,usd_amount:int):
        ...
        total_usd_in_ils = CurrencyConverter().convert(usd_amount, "USD", "ILS",date=date(date.today().year,date.today().month,date.today().day))
    ...
    def get_guess_from_user(self,usd_amount):
        ...
        while not ((len(split_guess)==2 and currency_guess[0].isdigit() and currency_guess[1].isdigit()) or (len(split_guess)==1 and currency_guess.isdigit())):
